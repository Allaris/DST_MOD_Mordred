...
{ 
    ...
    Asset("ANIM", "anim/clarentblx.zip"), 
    Asset("ANIM", "anim/swap_clarentblx.zip"),  

    Asset("ATLAS", "images/inventoryimages/clarentblx.xml"), 
    Asset("IMAGE", "images/inventoryimages/clarentblx.tex"), 
...
local function fn()
    ...
    local function OnEquip(inst, owner)
        -- owner.components.combat.areahitrange=TUNING.CLARENTBLX_AOE_RNG
        owner.AnimState:OverrideSymbol("swap_object", "swap_clarentblx", "swap_clarentblx")
    ...
    anim:SetBank("clarentblx")
    anim:SetBuild("clarentblx")
    ...
    inst.components.weapon:SetDamage(TUNING.CLARENTBLX_DMG)
	inst.components.weapon:SetRange(TUNING.CLARENTBLX_RNG)
    ...
    inst.components.inventoryitem.imagename = "clarentblx"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/clarentblx.xml"
...
return  Prefab("common/inventory/clarentblx", fn, assets, prefabs)
